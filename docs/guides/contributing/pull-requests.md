...
* [Reviewing Pull Requests](#reviewing-pull-requests)
  ...
  * [Accept that there are different opinions about what belongs in Mambaex](#accept-that-there-are-different-opinions-about-what-belongs-in-mambaex)
...
Mambaex has no direct bundled dependencies. But do we had dev Dependencies

In case of doubt, open an issue with discussion tag.

## Setting up your local environment

To get started, you will need to have `git` , `python` installed locally.
...
Fork the project [on GitHub](https://github.com/pfarkya/mambaex) and clone your fork
locally.

```text
$ git clone git@github.com:username/mambaex.git
$ cd mambaex
$ git remote add upstream https://github.com/pfarkya/mambaex.git
$ git fetch upstream
```
...
We have main code inside the `mambaex` directory and documentation within `docs` directory.
...
4. If your patch fixes an open issue, you can add a reference to it at the end
   ...
   Examples:
   * `Fixes: https://github.com/pfarkya/mambaex/issues/1`
   * `Refs: https://github.com/pfarkya/mambaex/pull/1`
...
If you are new to contributing to Mambaex, please try to do your best at
...
This ensures that your working branch has the latest changes from `pfarkya/mambaex`
master.

### Step 6: Test

Bug fixes and features should always come with tests. Looking at other tests to see how they
should be structured can also help.

The `tests` directory within the `pfarkya/mambaex` repository is complex and it is
...
Contributors guide: https://github.com/pfarkya/mambaex/blob/master/CONTRIBUTING.md
-->
...
- [ ] commit message follows [commit guidelines](https://github.com/prfarkya/mambaex/blob/master/docs/guides/contributing/pull-requests.md#commit-message-guidelines)
```
...
at least two Mambaex Collaborators (one Collaborator approval is enough if the
...
All Mambaex contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for Mambaex?
2. Does this change make Mambaex better, even if only incrementally?
...
Mambaex Collaborator landing the Pull Request but they can also be an
...
a particular change that makes Mambaex better, but the individual might just
not want to have anything to do with Mambaex ever again. The goal is not just
having good code.
...
Any Mambaex main Collaborator (any GitHub user with commit rights in the
`pfarkya/mambaex` repository) is authorized to approve any other contributor's
...
### Accept that there are different opinions about what belongs in Mambaex

Opinions on this vary, even among the members of the Mambaex Collaborators.
...
continuous integration (CI) testing at github pipeline.
...
to make sure that it works on the platforms that Mambaex
